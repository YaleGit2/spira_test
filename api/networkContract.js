...
const epcisChaincodeName = 'epcis';
const traceabilityChaincodeName = 'traceability';
...
async function connectToContract() {
  ...
  const epcisContract = network.getContract(epcisChaincodeName);
  const traceabilityContract = network.getContract(traceabilityChaincodeName);
  ...
  if (queryConfig.SubscriptionStatus) {
    ...
    await epcisContract.addepcisContractListener(listener);
  }
