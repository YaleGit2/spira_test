...
express_app.get('/users', (req, res) => {
  return userController.userList(req, res);
});
express_app.post('/approve', (req, res) => {
  return userController.userApprove(req, res);
});
express_app.post('/update', (req, res) => {
  return userController.userUpdate(req, res);
});
express_app.post('/delete', (req, res) => {
  return userController.userDelete(req, res);
});
