...
exports.getDigitalLinkFormat = (epc) => {
  try {
    if (epc.startsWith('urn')) {
      ...
      if (values[3] == 'sscc') {
        return process.env.GS1_DIGITAL_LINK + '00/' + values[4];
      }
      if (values[3] == 'gtin') {
        return process.env.GS1_DIGITAL_LINK + '01/' + values[4];
      }
      if (values[3] == 'sgtin') {
      ...
      if (values[3] == 'grai') {
        return process.env.GS1_DIGITAL_LINK + '8003/' + values[4];
      }
      if (values[3] == 'giai') {
        return process.env.GS1_DIGITAL_LINK + '8004/' + values[4];
      }
      if (values[3] == 'gsrn') {
        return process.env.GS1_DIGITAL_LINK + '8018/' + values[4];
      }
      if (values[3] == 'gsrnp') {
        return process.env.GS1_DIGITAL_LINK + '8017/' + values[4];
      }
      if (values[3] == 'gdti') {
        return process.env.GS1_DIGITAL_LINK + '253/' + values[4];
      }
      if (values[3] == 'cpi') {
        return process.env.GS1_DIGITAL_LINK + '8010/' + values[4];
      }
      if (values[3] == 'gcn') {
        return process.env.GS1_DIGITAL_LINK + '255/' + values[4];
      }
      if (values[3] == 'ginc') {
        return process.env.GS1_DIGITAL_LINK + '401/' + values[4];
      }
      if (values[3] == 'gsin') {
        return process.env.GS1_DIGITAL_LINK + '402/' + values[4];
      }
      if (values[3] == 'itip') {
      ...
      if (values[3] == 'gln') {
        return process.env.GS1_DIGITAL_LINK + '414/' + values[4];
      }
      if (values[3] == 'sgln') {
      ...
      if (values[3] == 'pgln') {
        return process.env.GS1_DIGITAL_LINK + '417/' + values[4];
      } else {
        return epc;
      }
    }
...
https: exports.getURNFormat = (epc) => {
  try {
      ...
      if (values[3] == '414') {
        if (typeof values[5] !== 'undefined') {
          if (values[5] == '254') {
            ...
            return (
              'urn:epc:id:sgln:' + values[4] + ser + values[values.length - 1]
            );
          } else {
            var ser = '';
            var count = 4;
