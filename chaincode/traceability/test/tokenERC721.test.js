...
describe('Chaincode', () => {
    ...
    describe('#BalanceOf', () => {
        it('should work', async () => {
            const mockResponse = [
                { key: 'balance_Alice_101', value: '101' },
                { key: 'balance_Alice_102', value: '102' }
            ];
    ...
    describe('#Name', () => {
        it('should work', async () => {
            ...
            expect(response).to.equals(tokenName);
        });
    });
    ...
    describe('#MintWithTokenURI', () => {
        it('should work with a new token', async () => {
            ...
            const nft = { tokenId: '101', owner: 'Alice',  org: 'Org1MSP', tokenURI: 'DummyURI' };
            sinon.assert.calledWith(mockStub.putState.getCall(0), 'nft_101', Buffer.from(JSON.stringify(nft)));
            sinon.assert.calledWith(mockStub.putState.getCall(1), 'balance_Alice_101', '101');
